...
type c if you arent wearing a trouser next week.''')
    ...
    for trous in trousers_list:
        print(trous)
    next_week_trouser  = input()
    # ensure the trouser i pick is actually in the list of trousers i originally can wear on sunday
    if next_week_trouser in trousers_list:
        trousers_list.remove(next_week_trouser)
    elif next_week_trouser in trousers_list_copy:
        pass
    elif next_week_trouser == 'c':
        pass
    else:
        print('The trouser you entered is not part of the list, please check, copy and paste the name of the trouser you wore')
        random_cloth_picker_if_i_wore_a_trouser_on_sunday(trouser, unavailableShirts_list, unavailableTrousers_list)
...
def unavailable_shirt(trouser, unavailableTrousers_list):
    ...
    if ans in allowed_inputs:
        ...
        if ans in ['y', 'yes']:
            ...
            if trouser:
                random_cloth_picker_if_i_wore_a_trouser_on_sunday(trouser, None, unavailableTrousers_list)
